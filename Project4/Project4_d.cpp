/*   Problem 4 d)
   ...
   Compute P(E) of steady state in
   a 20x20 lattice Ising model with periodic boundary conditions */
...
int main(int argc, char* argv[]) {
  ...
  ofile << "Final number of Monte Carlo cycles: " << mcs << ", and temperature: " << temperature << endl;
...
void read_input(int& n_spins, double& temperature, int& mcs) {
  ...
  cout << "Final number of Monte Carlo cycles: ";
  cin >> mcs;
