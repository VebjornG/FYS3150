/*
 ...
 Trying to spot a phase transition by plotting various quantities
 as a function of temperature. We consider a periodic Ising model for,
 40x40, 60x60, 100x100 and 140x140 in the temperature range T = [2.0,2.4].
 The exact transition occurs at T_c = 2.269 in the thermodynamic limit.
...
void read_input(int& n_spins, int& mcs, double& initial_temp,
  ...
  cout << "Number of Monte Carlo cycles: ";
  cin >> mcs;
  cout << "Lattice size or number of spins (x = y): ";
  cin >> n_spins;
...
void output(int n_spins, int mcs, double temperature, double *average, double calc_time) {
  ...
  // all expectation values are per spin, divided by 1/n_spins/n_spins
